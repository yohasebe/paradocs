/**
 * helper.js - Ported from lib/helper.rb
 * Generates dynamic CSS <style> block based on configuration values.
 */

function createCSS(conf) {
  let fontFamilyBody;
  let fontFamilyHeading;

  if (conf.font_family === "sans") {
    fontFamilyBody = '"Lato", sans-serif';
    fontFamilyHeading = '"News Cycle", Impact, sans-serif';
  } else if (conf.font_family === "serif") {
    fontFamilyBody = '"Palatino Linotype", "Book Antiqua", Palatino, FreeSerif, serif';
    fontFamilyHeading = '"Palatino Linotype", "Book Antiqua", Palatino, FreeSerif, serif';
  } else if (conf.font_family === "fun") {
    fontFamilyBody = '"Comic Sans MS","\u30D2\u30E9\u30AE\u30CE\u4E38\u30B4 Pro W4","\u30D2\u30E9\u30AE\u30CE\u4E38\u30B4 Pro","Hiragino Maru Gothic Pro","HG\u4E38\uFF7A\uFF9E\uFF7C\uFF6F\uFF78M-PRO","HGMaruGothicMPRO", cursive, sans-serif';
    fontFamilyHeading = '"Comic Sans MS","\u30D2\u30E9\u30AE\u30CE\u4E38\u30B4 Pro W4","\u30D2\u30E9\u30AE\u30CE\u4E38\u30B4 Pro","Hiragino Maru Gothic Pro","HG\u4E38\uFF7A\uFF9E\uFF7C\uFF6F\uFF78M-PRO","HGMaruGothicMPRO", cursive, sans-serif';
  }
