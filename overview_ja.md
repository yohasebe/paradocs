...
これにより、発表者が今どのセンテンスに注目しているか、オーディエンスは把握することができます。
...
作成したプレゼンは、ユーザー自身による口頭での発表に使うことができます。<span class='marker'>あるいは、全体を自動でプレゼンさせることもできます。</span>画面左上の魔法の杖アイコンをクリックしてください。現在のスライドの次の断片から発表全体の最終の断片まで、テキストの読み上げや動画再生などが次々と自動で実行されます。
